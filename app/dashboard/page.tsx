    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Bem-vindo ao seu painel de controle da Permanência Escolar.</p>
        </div>
        <div className="flex items-center gap-2">
          <Button className="bg-emerald-600 hover:bg-emerald-700" asChild>
            <Link href="/dashboard/forms">Preencher Formulário</Link>
          </Button>
        </div>
      </div>
      ...
      <Tabs defaultValue="professor" className="space-y-4">
        ...
        <TabsContent value="gestor" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">+0.4 em relação ao ano anterior</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                <CardTitle>Análise de Evasão</CardTitle>
                <CardDescription>Tendência de evasão escolar nos últimos 5 anos</CardDescription>
              </CardHeader>
              <CardContent className="pl-2">
                <div className="h-[200px] bg-slate-100 rounded-md flex items-center justify-center">
                  <p className="text-sm text-slate-500">Gráfico de tendência de evasão seria exibido aqui</p>
                </div>
              </CardContent>
            </Card>
            <Card className="col-span-3">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Taxa de evasão por turma</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="text-sm font-medium">1º Ano A</div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="text-sm font-medium">1º Ano B</div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="text-sm font-medium">2º Ano A</div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="text-sm font-medium">2º Ano B</div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="text-sm font-medium">3º Ano A</div>
